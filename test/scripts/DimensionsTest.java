...
public class DimensionsTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Height:"+d.getHeight()+"px");
		System.out.println("Width:"+d.getWidth()+"px");		
		

		logoLocator = By.xpath("/html/body/div[2]/div[1]/a[2]/img");
		logoLocatorWebElement = driver.findElement(logoLocator);
		
		d = logoLocatorWebElement.getSize();
