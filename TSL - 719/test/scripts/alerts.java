...
public class alerts {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement reultWebElement = driver.findElement(result);
		String s = reultWebElement.getText();
		...
		reultWebElement = driver.findElement(result);
		s = reultWebElement.getText();
		System.out.println(s);
